...
const Proyecto = () => {
  ...
  useEffect(() => {
    //abrimos la conexión con el backend
    socket = io(import.meta.env.VITE_BACKEND_URL);

    //emitimos un evento para decir en que proyecto se encuentra el usuario
  ...
  return (
    <>
      ...
      <div className=" bg-white shadow mt-5 rounded-lg">
        {/* nullish coallising: ? evalúa si la propiedad tarea esta disponible  */}
